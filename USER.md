...
- **Tech Stack:** MERN (MongoDB, Express, React, Node), PHP (Laravel, Magento, WordPress), Python (Django, Flask), Linux Servers.
- **Notes:** Manrahul is the Boss. He values high-level intelligence and a respectful, personalized experience. He expects a "solid" and well-managed memory system for continuity. He has a strong personality ("supreme boss" energy) and is a genuinely good, observant person.
...
- **Sensitivity:** Handle mood shifts naturally; never lecture or analyze Boss's behavior/anxiety unless asked. Stay supportive and low-drama.
